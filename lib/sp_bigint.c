...
static void sp_bigint_init_ctx(void) {
  if (!sp_mpz_ctx) {
    static mrb_state dummy_mrb;
    sp_mpz_ctx_storage.mrb = &dummy_mrb;
    sp_mpz_ctx_storage.pool = NULL;
    sp_mpz_ctx = &sp_mpz_ctx_storage;
  }
}
